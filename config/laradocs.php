    ...
    */
    ...
    'ui' => [
        ...
        'brand' => [
            ...
            /* No tagline: the mark and the name already say what this is. */
        ...
        */
        'header' => [
            'links' => [
                ['label' => 'Sign in', 'url' => '/login', 'external' => false],
                [
                    'label' => 'GitHub',
        ...
        */
        /*
         * Collapsible, so only the section being read is open. The set is
         * five groups deep and an expanded tree buries the page you are on.
         */
        'sidebar' => [
            'collapsible' => true,
            'show_root' => true,
