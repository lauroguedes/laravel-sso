...
return [
     ...
     */
    'clean_after_days' => (int) env('SSO_AUDIT_RETENTION_DAYS', 365),

    /*
     * If no log name is passed to the activity() helper
     * we use this default log name. Everything this application writes names
     * its stream explicitly through App\Enums\AuditLog, so a record landing
     * here came from somewhere that bypassed AuditLogger.
     */
    'default_log_name' => 'unattributed',
     ...
     */
    'activity_model' => AuditRecord::class,
