...
return [
    ...
    */
    ...
    'credentials' => [
        ...
        'accounts' => [
            [
                'email' => env('DEMO_EMAIL', 'admin@'.SsoDemoSeeder::DOMAIN),
                'label' => 'Administrator',
                'rotate' => true,
                'primary' => true,
                'password' => null,
    ...
    */
    ...
    'guards' => [
         ...
         */
        'protected' => [
            User::class => ['email' => env('DEMO_EMAIL', 'admin@'.SsoDemoSeeder::DOMAIN)],
        ],
    ...
    */
    ...
    'banner' => [
        ...
        /*
         ...
         | root so the application's stylesheet cannot reach it. 'bare' is semantic markup wearing the
        ...
        'cta' => [
            ...
            'url' => env('DEMO_BANNER_CTA_URL', 'https://github.com/lauroguedes/laravel-sso'),
        ],
